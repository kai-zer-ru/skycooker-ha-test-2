...
class TestSkyCookerConnectionAttributes:
    ...
    def test_current_temp_property_exists(self):
        """Test that the target_boil_minutes property exists in SkyCookerConnection."""
        connection = SkyCookerConnection("test_mac", "test_key", persistent=False, model="RMC-M40S")
        assert hasattr(connection, 'target_boil_minutes'), "SkyCookerConnection should have a 'target_boil_minutes' property"
