#!/usr/bin/env python3
"""
Тестирование интеграции skycooker напрямую.
Этот скрипт проверяет, что все ошибки в интеграции исправлены.
"""
...
from custom_components.skycooker.btle import RedmondCommand
...
async def test_integration():
    ...
    try:
        ...
        conn = BTLEConnection(mac_address, password)
        ...
        # Тестируем отправку команды статуса
        logger.info("📊 Отправка команды статуса...")
        await conn.sendRequest(RedmondCommand.STATUS)
